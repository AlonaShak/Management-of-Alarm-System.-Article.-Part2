...
p\) завершення підготовки експлуатації тривог та системи в цілому;

q\) обслуговування (підтримка)ведення журналів тривог та хронології тривог;

r\) обслуговування головної бази даних тривог;

s\) загальні випадки проектування обладнання (попередньо визначені тривоги);

t\) організація та регулярне обслуговування системи;

u\) вирішення проблем системи;

v\) дослідження відхилень у процесі, для яких існують записи тривог, особливо тих що стосуються охорони здоров\'я, безпеки, навколишнього середовища та якості продукції;

w\) періодичний перегляд/оновлення документа методології тривог;

x\) документування результатів раціоналізації та проведення проектних заходів;

y\) документування результатів тестування тривог;

z\) документування матеріалів для підготовки персоналу до експлуатації системи;

aa) періодичний аудит системи.
